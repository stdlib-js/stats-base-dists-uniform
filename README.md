...
```javascript
import uniform from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dists-uniform@v0.2.1-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { Uniform, cdf, entropy, kurtosis, logcdf, logpdf, mean, median, mgf, pdf, quantile, skewness, stdev, variance } from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dists-uniform@v0.2.1-esm/index.mjs';
```
